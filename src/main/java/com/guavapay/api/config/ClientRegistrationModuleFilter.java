...
@Component
public class ClientRegistrationModuleFilter extends AbstractGatewayFilterFactory<ClientRegistrationModuleFilter.Config> {
    ...
    public ClientRegistrationModuleFilter() {
        super(ClientRegistrationModuleFilter.Config.class);
    }
    ...
    @Override
    public GatewayFilter apply(ClientRegistrationModuleFilter.Config config) {
